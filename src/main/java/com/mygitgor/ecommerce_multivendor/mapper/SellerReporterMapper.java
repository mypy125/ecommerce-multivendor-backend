...
import com.mygitgor.ecommerce_multivendor.domain.model.SellerReporter;
import com.mygitgor.ecommerce_multivendor.infrastructure.database.entitiy.SellerReportEntity;
import org.mapstruct.Mapper;
import org.mapstruct.factory.Mappers;

@Mapper(componentModel = "spring")
public interface SellerReporterMapper extends ConfigMapper<SellerReporter, SellerReportEntity> {
